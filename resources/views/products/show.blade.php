        ...
        <main class="p-4 lg:p-8 flex-grow w-full">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2 text-slate-500 text-[10px] uppercase font-bold tracking-widest mb-1">
                            <span>Produits</span>
                            <i
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                <!-- Image Produit -->
                <div class="bg-white p-2 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-center overflow-hidden">
                    @if ($product->image)
                        <img
                            src="{{ asset('uploads/' . $product->image) }}"
                            alt="{{ $product->name }}"
                            class="w-full h-48 object-contain hover:scale-105 transition-transform duration-500"
                        >
                    @else
                ...
                <div class="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-indigo-600 p-8 rounded-3xl shadow-lg shadow-indigo-200 text-white flex flex-col justify-between md:row-span-2 relative overflow-hidden group">
                        <i
                            ...
                            class="w-24 h-24 absolute -right-6 -bottom-6 opacity-20 group-hover:scale-110 transition-all"
                        ></i>
                        <div>
                        ...
                        <div class="mt-8">
                            <span class="bg-white/20 px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider">
                                Ventes du produit
                            </span>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <!-- Fournisseur -->
                <div class="bg-slate-900 p-8 rounded-3xl shadow-xl shadow-slate-200 text-white relative overflow-hidden">
                    <i
                        data-lucide="truck"
                        class="w-20 h-20 absolute -right-4 -bottom-4 opacity-5"
                    ></i>
                    <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-6">
                        Fournisseur
                    </h3>
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center font-black text-indigo-400 border border-white/10">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-2">
                                            @php
                                                ...
                                                ->implode('');
                                            @endphp
                                            <div class="w-6 h-6 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-[10px] font-black">
                                                {{ $initials ?: '?' }}
                                            </div>
