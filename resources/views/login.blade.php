...
<body class="bg-animate min-h-screen flex items-center justify-center p-4 overflow-hidden relative">
    ...
    <div class="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-purple-600/20 rounded-full blur-[120px] animate-pulse" style="animation-delay: 2s;"></div>

    <div class="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 glass-card rounded-[2.5rem] overflow-hidden shadow-2xl relative z-10">
        
        <!-- Left Side: Branding & Creative -->
        <div class="hidden lg:flex flex-col justify-between p-12 bg-white/5 border-r border-white/10 relative overflow-hidden">
            <!-- Pattern decor -->
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-3 mb-12">
                    ...
                    <span class="text-2xl font-black text-white tracking-tighter">WoStock <span class="text-[10px] bg-indigo-600 px-2 py-0.5 rounded-full uppercase ml-1">beta</span></span>
                </div>

                <h2 class="text-5xl font-black text-white leading-tight mb-6">
                    Gérez votre <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">Stock & Ventes</span> <br>
                    avec élégance.
                </h2>
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5 inline-flex">
                    ...
                    <p class="text-xs font-bold text-slate-300 uppercase tracking-widest">+500 Entreprises nous font confiance</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 lg:p-16 flex flex-col justify-center bg-slate-950/40">
            ...
            <form class="space-y-6" onsubmit="handleLogin(event)">
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Adresse E-mail</label>
                    <div class="relative">
                        <i data-lucide="mail" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500"></i>
                        <input type="email" required placeholder="admin@wostock.ma" 
                ...
                <div class="flex items-center gap-3 px-1">
                    <input type="checkbox" id="remember" class="w-4 h-4 rounded border-white/10 bg-white/5 text-indigo-600 focus:ring-indigo-500">
                    <label for="remember" class="text-xs text-slate-400 font-medium cursor-pointer">Se souvenir de moi</label>
                </div>
                ...
                <button type="submit" id="loginBtn"
                    ...
                    <span class="relative z-10 flex items-center justify-center gap-2">
                        Connexion <i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                    </span>
                    <!-- Shine Effect -->
            ...
            <div class="mt-12 text-center">
                <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em]">
                    Powered by <a href="https://wobranding.com" target="_blank" class="text-indigo-400 hover:underline">WoBranding</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function handleLogin(e) {
            ...
            // Animation dial loading
            btn.innerHTML = `<i data-lucide="loader-2" class="w-5 h-5 animate-spin"></i> Authentification...`;
            lucide.createIcons();
            btn.disabled = true;

            // Simuler la connexion
            setTimeout(() => {
                window.location.href = '/index.php'; // Redirection vers dashboard
            }, 1500);
        }
    </script>
