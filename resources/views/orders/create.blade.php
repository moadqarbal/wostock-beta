                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    <option value="manuelle" {{ old('source', 'manuelle') === 'manuelle' ? 'selected' : '' }}>
                                        Manuel
                                    </option>
                                    ...
                                    <option value="woocommerce" {{ old('source') === 'woocommerce' ? 'selected' : '' }}>
                                        WooCommerce
                                    </option>
                        ...
                        <div class="bg-slate-900 p-8 rounded-3xl shadow-xl shadow-slate-200 text-white relative overflow-hidden">
                            ...
                            <i data-lucide="calculator"
                                class="absolute -right-4 -bottom-4 w-24 h-24 opacity-5"></i>
