<?php
/**
 * Logic: This page should only be accessible if no admin exists in the DB.
 */
$adminExists = false; // Check your DB here: SELECT COUNT(*) FROM users
...
<body class="min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-[500px]">
        ...
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-3xl shadow-xl shadow-slate-200/50 mb-6">
        ...
        <div class="setup-card rounded-[2.5rem] p-8 lg:p-12 shadow-2xl shadow-slate-200 border border-white">
            <form class="space-y-5" onsubmit="handleRegister(event)">
                ...
                <!-- Username -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Nom d'utilisateur</label>
                    <div class="relative">
                        <i data-lucide="user" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400"></i>
                        <input type="text" id="username" required placeholder="ex: moad_admin" 
                ...
                <!-- Confirm Password -->
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Confirmation</label>
                    <div class="relative">
                        <i data-lucide="shield-check" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400"></i>
        ...
        <div class="mt-12 text-center">
             <div class="flex items-center justify-center gap-2 mb-2">
                ...
                <span class="text-xs font-black text-slate-400 tracking-tighter uppercase">WoStock beta</span>
            </div>
            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.4em]">Propulsé par WoBranding</p>
        </div>
    </div>
    ...
    <script>
        ...
        function handleRegister(e) {
            ...
            btn.innerHTML = `<i data-lucide="loader-2" class="w-5 h-5 animate-spin"></i> CRÉATION EN COURS...`;
            lucide.createIcons();
            btn.disabled = true;
