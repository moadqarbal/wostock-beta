...
<head>
    ...
    <title>Application - WoStock Installer</title>
    ...
    <div class="w-full rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-500">
                Configure your WoStock application.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('installer.application.store') }}" class="space-y-5">
            @csrf
