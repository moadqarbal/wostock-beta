        ...
        <main class="flex-1 p-4 md:p-6 lg:p-8">
            ...
            <form method="GET" action="{{ route('clients.index') }}"
                ...
                <div class="relative w-full md:w-96">
                    ...
                    <input type="text" id="clientSearch" name="search" value="{{ request('search') }}"
                        placeholder="Rechercher par nom, téléphone, email ou adresse..." autocomplete="off"
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            {{-- View --}}
                                            <a href="{{ route('clients.show', $client) }}" title="Voir"
                                    ...
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            <div
                                                ...
                                                <i data-lucide="users-round" class="w-7 h-7 text-slate-400"></i>
                                            </div>
                ...
                <div
                    ...
                    <div data-pagination class="flex items-center gap-1">
                        @if ($clients->hasPages())
                            ...
                            @else
                                <a href="{{ $clients->previousPageUrl() }}" data-pagination-link
                            ...
                            @foreach ($pages as $page)
                                ...
                                @else
                                    <a href="{{ $clients->url($page) }}" data-pagination-link
                            ...
                            @if ($clients->hasMorePages())
                                <a href="{{ $clients->nextPageUrl() }}" data-pagination-link
                                    class="w-9 h-9 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 transition-all">
